  ...
  return (
    <div>
      <div className="mb-10">
        ...
        <p className="text-[var(--text-secondary)] text-[15px]">Sign in to your account to continue</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            <input id="password" name="password" type={showPassword ? 'text' : 'password'} value={formData.password} onChange={handleChange} className={`input-field pr-12 ${errors.password ? 'border-red-500/40 ring-2 ring-red-500/10' : ''}`} placeholder="Enter your password" />
