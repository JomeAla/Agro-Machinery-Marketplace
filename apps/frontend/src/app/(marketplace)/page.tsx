...
const categoryData = [
  ...
  { name: 'Implements', slug: 'implements', desc: 'Plows, cultivators & more', icon: 'M11.42 15.17l-4.655 2.688A2 2 0 014.56 16.34V7.66a2 2 0 012.205-1.52l4.655 2.687a2 2 0 010 3.04zM19.5 8.25l-7.5 4.5' },
  { name: 'Spare Parts', slug: 'spare-parts', desc: 'Genuine parts & components', icon: 'M11.42 15.17l-4.655 2.688A2 2 0 014.56 16.34V7.66a2 2 0 012.205-1.52l4.655 2.687a2 2 0 010 3.04z M15.44 8.46l4.655-2.687A2 2 0 0122.34 7.66v8.68a2 2 0 01-2.205 1.52l-4.655-2.687a2 2 0 010-3.04z' },
  { name: 'Irrigation', slug: 'irrigation-equipment', desc: 'Water management systems', icon: 'M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z' },
  { name: 'General Equipment', slug: 'general-equipment', desc: 'Quality seeds & fertilizers', icon: 'M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18' },
];
