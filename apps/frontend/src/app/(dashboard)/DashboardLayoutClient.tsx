...
const navigation = [
  ...
  { name: 'Maintenance', href: '/seller/maintenance', icon: MaintenanceIcon },
  { name: 'Support', href: '/support', icon: SupportIcon },
  { name: 'Ad Manager', href: '/seller/promotions', icon: PromotionsIcon },
  { name: 'Analytics', href: '/seller/analytics', icon: AnalyticsIcon },
];
